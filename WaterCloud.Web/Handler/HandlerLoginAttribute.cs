    ...
    public class HandlerLoginAttribute : ActionFilterAttribute
    {
        ...
        public override void OnActionExecuting(ActionExecutingContext filterContext)
        {
            ...
            if (OperatorProvider.Provider.GetCurrent() == null)
            {
                ...
                filterContext.HttpContext.Response.WriteAsync("<script>top.location.href = '/Content/page/error.html?msg=" + "系统登录已超时，请重新登录！" + "';</script>");
                return;
            }
            //登录检测
            ...
            try
            {
                ...
                switch (result.stateCode)
                {
                    ...
                    case 0:
                        ...
                        return false;
                    case -1:
                        filterContext.HttpContext.Response.WriteAsync("<script>top.location.href = '/Content/page/error.html?msg=" + "账号未登录，请登录！" + "';</script>");
                        return false;
                    case -2:
                        filterContext.HttpContext.Response.WriteAsync("<script>top.location.href = '/Content/page/error.html?msg=" + "您的帐号已在其它地方登录,请重新登录！" + "';</script>");
                        return false;
                    default:
                        return false;
                }
