...
layui.define(['form', 'element'], function (exports) {
  ...
  Class.prototype.render = function () {
    ...
    // 底部区域
    var elemFooter = [
        (!!options.run ?'<div class="cron-title">最近运行时间</div>':''),
      '<div class="cron-box" id="run-list"></div>',
        '<div class="cron-box"><div class="cron-footer-btns">' + (!!options.run?'<span lay-type="run" class="cron-btns-run">运行</span>':'')+'<span lay-type="confirm" class="cron-btns-confirm">确定</span></div></div>',
    ];
