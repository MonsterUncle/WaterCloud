    ...
    TreeTable.prototype.init = function () {
        ...
        if ($elem.next('.ew-tree-table').length === 0) {
            ...
            $elem.after([
                ...
                '      <table class="layui-table"></table>',
                options.loading == true ? '      <div class="ew-tree-table-loading">' : '      <div class="ew-tree-table-loading layui-hide">',
