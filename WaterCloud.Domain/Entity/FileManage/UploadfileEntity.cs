...
namespace WaterCloud.Domain.FileManage
{
    ...
    public class UploadfileEntity : IEntity<UploadfileEntity>,ICreationAudited
    {
        ...
        /// </summary>
        /// <returns></returns>
        [SugarColumn(IsNullable = true, ColumnName = "FilePath",ColumnDataType = "nvarchar(50)", ColumnDescription = "文件路径")]
        public string FilePath { get; set; }
        /// <summary>
        /// 文件名称
        /// </summary>
        /// <returns></returns>
        [SugarColumn(IsNullable = false, ColumnName = "FileName",ColumnDataType = "nvarchar(200)", ColumnDescription = "文件名称", UniqueGroupNameList = new string[] { "oms_uploadfile" })]
        ...
        /// </summary>
        /// <returns></returns>
        [SugarColumn(IsNullable = true, ColumnName = "FileExtension", ColumnDataType = "nvarchar(20)", ColumnDescription = "文件扩展名")]
        public string FileExtension { get; set; }
        /// <summary>
        /// 文件所属
        /// </summary>
        /// <returns></returns>
        [SugarColumn(IsNullable = true, ColumnName = "FileBy",ColumnDataType = "nvarchar(50)", ColumnDescription = "文件所属")]
