...
namespace WaterCloud.Domain.SystemManage
{
    ...
    public class ItemsDetailEntity : IEntity<ItemsDetailEntity>, ICreationAudited, IDeleteAudited, IModificationAudited
    {
        ...
        [SugarColumn(IsNullable = true, ColumnName = "ItemId", ColumnDataType = "nvarchar(50)", ColumnDescription = "分类Id", UniqueGroupNameList = new string[] { "sys_itemsdetail" })]
        public string ItemId { get; set; }
        /// <summary>
        /// 父级Id
        /// </summary>
        [SugarColumn(IsNullable = true, ColumnName = "ParentId", ColumnDataType = "nvarchar(50)", ColumnDescription = "父级Id", UniqueGroupNameList = new string[] { "sys_itemsdetail" })]
        public string ParentId { get; set; }
        /// <summary>
        /// 编号
        /// </summary>
        [Required(ErrorMessage = "编号不能为空")]
        [SugarColumn(IsNullable = true, ColumnName = "ItemCode",ColumnDataType = "nvarchar(50)", ColumnDescription = "编号", UniqueGroupNameList = new string[] { "sys_itemsdetail" })]
        public string ItemCode { get; set; }
        /// <summary>
        /// 名称
        /// </summary>
        [Required(ErrorMessage = "名称不能为空")]
        [SugarColumn(IsNullable = true, ColumnName = "ItemName", ColumnDataType = "nvarchar(50)", ColumnDescription = "名称")]
        public string ItemName { get; set; }
        /// <summary>
        /// 简拼
        /// </summary>
        [SugarColumn(IsNullable = true, ColumnName = "SimpleSpelling", ColumnDataType = "longtext", ColumnDescription = "简拼")]
